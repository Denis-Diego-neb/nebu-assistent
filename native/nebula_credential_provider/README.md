...
telefone confirma o PIN do Android e assina uma autorização com uma chave EC
P-256 do Android Keystore. No A71/Android 13, a chave exige autenticação por
credencial do dispositivo nos últimos 5 segundos. O PIN nunca sai do telefone.
...
Para preparar os binários, execute `build.ps1`. Depois, em uma janela elevada,
pareie a chave pública `files/unlock-public.der` do app instalado por USB e
salve-a como `phone_public.der` ao lado do instalador. Nunca exporte a chave privada.
