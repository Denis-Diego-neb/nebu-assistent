...
from config_modelo import obter_url_ollama
...
class ConversaLocal:
    ...
    @classmethod
    def _validar_resultado(cls, conteudo: str) -> ResultadoQwen:
        try:
        ...
        acoes = tuple(cls._validar_acao(item) for item in itens)
    ...
    def interpretar_ou_responder(self, texto: str) -> ResultadoQwen:
        comando_direto = self._comando_direto_animacao_musical(texto)
        ...
        resultado = self._validar_resultado(conteudo)
